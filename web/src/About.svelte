...
<Modal bind:show={$showAbout}>
  ...
  <p>
    ...
    interacts. From a start point, how far can somebody reach in 15 minutes by walking,
    cycling, or with public transit? Within that area, what points of interest are
    around?
  </p>
  <p>
    ...
    >
    or email
    <a href="mailto:dabreegster@gmail.com">dabreeegster@gmail.com</a>.
  </p>
  <p>
  ...
  <center><button on:click={() => ($showAbout = false)}>Start!</button></center>
</Modal>
